 ...
 */
public class ListDeadlineCommandParserTest {

    private ListDeadlineCommandParser parser = new ListDeadlineCommandParser();

    @Test
    public void parse_validArgs_returnsDeleteCommand() {
        assertParseSuccess(parser, STUDENT_ID_DESC_AMY, new ListDeadlineCommand(new StudentId(VALID_STUDENT_ID_AMY)));
    }
